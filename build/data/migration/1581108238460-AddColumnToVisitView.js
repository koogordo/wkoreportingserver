...
var AddColumnToVisitView1581108238460 = /** @class */ (function () {
    function AddColumnToVisitView1581108238460() {
        this.name = 'AddColumnToVisitView1581108238460';
    }
    AddColumnToVisitView1581108238460.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("INSERT INTO `wkohfatracking3`.`typeorm_metadata`(`type`, `schema`, `name`, `value`) VALUES (?, ?, ?, ?)", ["VIEW", "wkohfatracking3", "visit_question", "SELECT `visit`.`visitID` AS `visitID`, `visit`.`visitType` AS `visitType`, `visit`.`clientID` AS `clientID`, `visit`.`visitDate` AS `visitDate`, `visit`.`visitOs` AS `visitOs`, `visit`.`clientFullName` AS `clientFullName`, `visit`.`legacyClientID` AS `legacyClientID`, `question`.`questionKey` AS `questionKey`, `question`.`questionAnswer` AS `questionAnswer`, `question`.`questionType` AS `questionType`, `question`.`formIndexJSON` AS `formIndexJSON`, `question`.`questionJSON` AS `questionJSON`, `question`.`inputJSON` AS `inputJSON`, `question`.`isSubQuestionFlg` AS `isSubQuestionFlg`, `question`.`hasSubQuestionFlg` AS `hasSubQuestionFlg` FROM `visit` `visit` INNER JOIN `question` `question` ON `visit`.`visitID` = `question`.`visitVisitID`"])];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AddColumnToVisitView1581108238460.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("DELETE FROM `wkohfatracking3`.`typeorm_metadata` WHERE `type` = 'VIEW' AND `schema` = ? AND `name` = ?", ["wkohfatracking3", "visit_question"])];
    ...
    return AddColumnToVisitView1581108238460;
}());
exports.AddColumnToVisitView1581108238460 = AddColumnToVisitView1581108238460;
//# sourceMappingURL=1581108238460-AddColumnToVisitView.js.map